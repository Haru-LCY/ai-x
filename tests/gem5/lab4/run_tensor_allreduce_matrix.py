...
def cases():
    ...
    # Rectangular meshes (num-dirs stays a power of two).
    matrix.append(("tensor-4x2-r0-f16", 8, 8, 4, 0, 16))
    matrix.append(("tensor-4x2-r3-f4", 8, 8, 4, 3, 4))
    matrix.append(("tensor-4x2-r4-f64", 8, 8, 4, 4, 64))
    matrix.append(("tensor-2x4-r5-f16", 8, 8, 2, 5, 16))
    return matrix
